...
const miniCards = [
  ...
  { gradient: ["#22d3ee", "#155e75"], featured: false },
...
export function HeroVisual() {
  return (
    <div className="relative mx-auto w-full max-w-xl lg:mx-0">
                  ...
                  >
                    ...
                    <div className="space-y-1 p-2">
                      ...
                      <div className="flex items-center justify-between pt-0.5">
                        ...
                        <TrendingUp className="h-2.5 w-2.5 text-revenue" />
                      </div>
      ...
      <div className="absolute -right-4 -top-8 hidden h-16 w-16 rotate-12 rounded-2xl bg-brand-500 shadow-lg sm:block" />
      <div className="absolute -bottom-4 -left-4 hidden h-12 w-12 -rotate-12 rounded-2xl bg-brand-200 shadow-lg sm:block" />

      <div className="absolute -left-8 top-2 hidden items-center gap-2 rounded-xl border border-border bg-white px-3 py-2 shadow-xl sm:flex">
      ...
      <div className="absolute -right-8 bottom-0 hidden items-center gap-2 rounded-xl border border-border bg-white px-3 py-2 shadow-xl sm:flex">
      ...
      <div className="absolute -top-10 left-1/2 hidden w-44 -translate-x-1/2 -rotate-2 items-start gap-2 rounded-xl border border-border bg-white px-3 py-2.5 shadow-xl md:flex">
